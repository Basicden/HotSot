"""
HotSot Eta Service — API Contracts.
...
class CreateEtaRequest(BaseModel):
    """Request schema for creating a Eta entity."""
...
class UpdateEtaRequest(BaseModel):
    """Request schema for updating a Eta entity."""
    name: Optional[str] = Field(None, min_length=1, max_length=200)
    description: Optional[str] = Field(None, max_length=2000)


class ListEtaRequest(BaseModel):
    """Request schema for listing Eta entities with pagination."""
...
class EtaResponse(BaseModel):
    """Standard response schema for a Eta entity."""
    id: str
    tenant_id: str
    name: str
...
class EtaListResponse(BaseModel):
    """Paginated list response for Eta entities."""
    items: List[EtaResponse]
    total: int
    limit: int
    offset: int
    has_more: bool
...
class EtaEvent(BaseModel):
    """Kafka event schema for Eta events."""
