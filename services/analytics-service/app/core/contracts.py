"""
HotSot Analytics Service — API Contracts.
...
class CreateAnalyticsRequest(BaseModel):
    """Request schema for creating a Analytics entity."""
...
class UpdateAnalyticsRequest(BaseModel):
    """Request schema for updating a Analytics entity."""
    name: Optional[str] = Field(None, min_length=1, max_length=200)
    description: Optional[str] = Field(None, max_length=2000)


class ListAnalyticsRequest(BaseModel):
    """Request schema for listing Analytics entities with pagination."""
...
class AnalyticsResponse(BaseModel):
    """Standard response schema for a Analytics entity."""
    id: str
    tenant_id: str
    name: str
...
class AnalyticsListResponse(BaseModel):
    """Paginated list response for Analytics entities."""
...
class AnalyticsEvent(BaseModel):
    """Kafka event schema for Analytics events."""
